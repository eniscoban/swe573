var socialshot_main = {
	...
	addProject:function(){
        ...
        if(projectname.length>=3){
            $.ajax({ 
                type: "POST",
                url: "/a/socialshot/ax/addProject",
    ...
    saveDesignSettings:function(){
        ...
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/saveDesignSettings",
            data: { 
    ...
    saveTextSettings:function(){
        ...
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/saveTextSettings",
            data: { 
    ...
    saveProjectName:function(){
        ...
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/saveProjectName",
            data: { 
                prjName : prjName,
                projectID : projectID
            },
    ...
    saveEmailSettings:function(){
        ...
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/saveEmailSettings",
            data: { 
    ...
    logoutDevice:function(deviceId,projectId){
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/logoutDevice",
            data: { 
                deviceId : deviceId,
                projectId: projectId
            },
    ...
    closeProject:function(projectId){
        $.ajax({ 
            type: "POST",
            url: "/a/socialshot/ax/closeProject",
            data: { 
                projectId: projectId
            },
            success : function(response){ 
